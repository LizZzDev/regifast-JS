            ...
            <table className="montserratChiquita">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button 
                      onClick={() => handleOpiniones("Tech Solutions S.A.", "tech_solutions.png")}
                  ...
                  <td>
                    <button 
                      onClick={() => handlePostular("Tech Solutions S.A.")}
                      className="form-button"
                    >
                      Postular
                    </button>
                ...
                <tr>
                  ...
                  <td>
                    <button 
                      onClick={() => handleOpiniones("Marketing Digital MX", "marketing_digital.png")}
                      className="form-button"
                    >
                      Opiniones
                    </button>
                  ...
                  <td>
                    <button 
                      onClick={() => handlePostular("Marketing Digital MX")}
                      className="form-button"
                      disabled
                    >
                      Postular
                ...
                <tr>
                  ...
                  <td>
                    <button 
                      onClick={() => handleOpiniones("Consultoría Financiera ABC", "consultoria_financiera.png")}
                      className="form-button"
                    >
                      Opiniones
                    </button>
                  ...
                  <td>
                    <button 
                      onClick={() => handlePostular("Consultoría Financiera ABC")}
                      className="form-button"
                    >
                      Postular
                    </button>
