...
const NuevaContrasena = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const restablecerContraseñaEndpoint = await restablecerContrasena(
        nueva,
        token
      );
    ...
    <>
      ...
      <div id="nueva-container">
        <form id="nueva-form" onSubmit={handleSubmit}>
          ...
          {errores && (
            <p style={{ color: "red", textAlign: "center" }}>{errores}</p>
          )}

          <button id="nueva-button" type="submit">
            Cambiar contraseña
          </button>
        </form>
      </div>
